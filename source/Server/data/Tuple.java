...
public class Tuple {
	 ...
	 * @param i  è di tipo intero ricevuto in input per indicare la posizione nell'array : tuple
	...
	/**
	 * <p>Determina la distanza tra la tupla riferita da obj e la tupla corrente (riferita da this). La distanza è ottenuta come la somma delle distanze tra gli item in posizioni eguali nelle due tuple</p>
	...
	/**
	 * Effettua la conversione della tupla nel relativo Transfer Object
	 * @return TupleTO rappresentate il Transfer Object della tupla
	 */
	public TupleTO toTupleTO() {
		TupleTO to;
		to = new TupleTO(getLength());
		for (int i = 0; i < getLength(); i++) {
			to.get(i).setValue(get(i).getValue());
		}
		return to;
	}

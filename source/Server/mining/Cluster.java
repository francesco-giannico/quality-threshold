...
public class Cluster implements Iterable<Integer>, Comparable<Cluster>{
	 ...
	 * @return valore negativo se o è maggiore del cluster attuale, altrimenti 1. 
	 */
	 ...
	 * @return true o false in base a se è stato inserito o no nel cluster
	 */
	 ...
	 * @return intero che è la dimensione del clusterData
	 */
	int getSize(){
